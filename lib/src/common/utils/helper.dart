...
//               series._seriesType.contains('stacked') ||
...
//     }
//     if (series._seriesType.contains('range') &&
//         series._dataPoints[pointIndex].isVisible) {
//         final num high = series._dataPoints[pointIndex].high;
//         final num low = series._dataPoints[pointIndex].low;
//       series._dataPoints[pointIndex].high = math.max<num>(high,low);
//       series._dataPoints[pointIndex].low = math.min<num>(high,low);
//     }
//   }
// }
