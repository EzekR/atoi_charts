...
class _PyramidSeries {
  ...
  void calculatePyramidEmptyPoints(PyramidSeries<dynamic, dynamic> series) {
  ...
  void _processDataPoints() {
    for (PyramidSeries<dynamic, dynamic> series in visibleSeries) {
      ...
      calculatePyramidEmptyPoints(currentSeries);
      _getVisiblePoints();
      _setPointStyle();
      _findSumOfPoints();
    }
  ...
  void _getPathSegment(String seriesType, PointInfo<dynamic> point) {
